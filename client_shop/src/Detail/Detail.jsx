                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="row align-items-stretch mb-4">
                            ...
                            <a className="btn btn-link text-dark p-1 mb-4" href="#">
                                <i className="far fa-heart mr-2"></i>Thêm vào danh sách ưu thích
                        </a>
                            <br></br>
                        ...
                        review === 'description' ? (
                            <div className="tab-pane fade show active">
                                <div className="p-4 p-lg-5 bg-white">
                                    ...
                                    <p className="text-muted text-small mb-0">Mô tả.</p>
                                </div>
                            </div>
                        ) : (<div className="tab-pane fade show active">
                            <div className="p-4 p-lg-5 bg-white">
                        ...
                        product && product.map(value => (
                            <div className="col-lg-3 col-sm-6" key={value._id}>
                                <div className="product text-center skel-loader">
                                    ...
                                    <h6> <a className="reset-anchor" href="detail.html"></a></h6>
