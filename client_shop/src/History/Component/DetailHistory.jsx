...
function DetailHistory(props) {
    ...
    return (
        <div className="container">
            ...
            <div className="p-5">
                <h1 className="h2 text-uppercase">Thông tin đon hàng</h1>
                <p>ID Người dùng: {information.idUser}</p>
                <p>Tên: {information.fullname}</p>
                <p>Số điện thoại: {information.phone}</p>
                <p>Địa chỉ: {information.address}</p>
                <p>Tổng cộng: {information.total} VND</p>
            </div>
                    ...
                    <tbody>
                        {
                            cart && cart.map((value) => (
                                <tr className="text-center" key={value.idProduct}>
                                    ...
                                    <td className="align-middle border-0">
                                        <h6 className="mb-0">{value.priceProduct} VND</h6>
                                    </td>
                                    <td className="align-middle border-0">
