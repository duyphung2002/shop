                                ...
                                <div style={{ width: '100%' }}>
                                    <div className="card card-bordered fix_boderChat">
                                        <div className="card-header">
                                            <h4 className="card-title"><strong>Hỗ trợ khách hàng</strong></h4> <a className="btn btn-xs btn-secondary" href="#">Chat App</a>
                                        </div>
                                        ...
                                        <div className="publisher bt-1 border-light">
                                            ...
                                            <input type="text" placeholder="Nhập vào tin nhắn!" onChange={onChangeText} value={textMessage} />
