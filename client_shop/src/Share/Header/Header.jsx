        ...
        <div className="container px-0 px-lg-3">
            <nav className="navbar navbar-expand-lg navbar-light py-3 px-lg-0">
                <Link className="navbar-brand" to={`/`}>
                    <span className="font-weight-bold text-uppercase text-dark">HDDK</span>
                </Link>
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <ul className="navbar-nav mr-auto">
                        <li className="nav-item" onClick={() => handlerActive('Home')}>
                            ...
                            style={active === 'Home' ? { color: '#2287ed' } : {color: 'black'}} >Trang chủ</Link>
                        </li>
                        <li className="nav-item" onClick={() => handlerActive('Shop')}>
                            <Link className="nav-link" to={`/shop`} 
                            style={active === 'Shop' ? { color: '#2287ed' } : {color: 'black'}} >Shop</Link>
                        </li>  
                    </ul>
