            ...
            <div className="container">
                            ...
                            <form>
                                <div className="row">
                                    <div className="col-lg-12 form-group">
                                        <label className="text-small text-uppercase" htmlFor="Fullname">Tên:</label>
                                        <input className="form-control form-control-lg" value={fullname} onChange={onChangeName} type="text" placeholder="Nhập vào tên của bạn" />
                                        {fullnameError && <span className="text-danger">* Vui lòng nhập tên của bạn!</span>}
                                    </div>
                                    <div className="col-lg-12 form-group">
                                        <label className="text-small text-uppercase" htmlFor="Email">Email: </label>
                                        <input className="form-control form-control-lg" value={email} onChange={onChangeEmail} type="text" placeholder="Nhập email của bạn!" />
                                        {emailError && <span className="text-danger">* Vui lòng nhập email của bạn!</span>}
                                        {emailRegex && <span className="text-danger">* Định dạng gmail không chính xác</span>}
                                    </div>
                                    <div className="col-lg-12 form-group">
                                        <label className="text-small text-uppercase" htmlFor="Phone">Số điện thoại: </label>
                                        <input className="form-control form-control-lg" value={phone} onChange={onChangePhone} type="text" placeholder="Nhập vào số điện thoại của bạn!" />
                                        {phoneError && <span className="text-danger">* Vui lòng nhập số điện thoại của bạn!</span>}
                                    </div>
                                    <div className="col-lg-12 form-group">
                                        <label className="text-small text-uppercase" htmlFor="Address">Địa chỉ: </label>
                                        <input className="form-control form-control-lg" value={address} onChange={onChangeAddress} type="text" placeholder="Nhập vào địa chỉ của bạn!" />
                                        {addressError && <span className="text-danger">* Vui lòng nhập vào địa chỉ của bạn!</span>}
                                    </div>
                                    <div className="col-lg-12 form-group">
                                            ...
                                            carts && carts.map(value => (
                                                <div key={value._id}>
                                                    <li className="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <span className="text-muted small">{value.priceProduct} x {value.count} VND</span>
                                                    </li>
                ...
                {success && (<section className="py-5">
                    <div className="p-5">
                        ...
                        {/* <p style={{ fontSize: '1.2rem' }}>Vui lòng check email của bạn.</p> */}
                    </div>
                </section>)}
            </div>
        </div>
