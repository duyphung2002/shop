                ...
                <div className="container">
                    ...
                    <section className="pt-5">
                        <header className="text-center">
                            <p className="small text-muted small text-uppercase mb-1">Bộ sưu tập</p>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <Link className="category-item" to={'/shop'}>
                                    ...
                                    {/* <strong className="category-item-title">Accessory</strong> */}
                                </Link>
                            </div>
                        </div>
                    </section>
                    <section className="py-5" id="section_product">
                        <header>
                            ...
                            <h2 className="h5 text-uppercase mb-4">Sản phẩm thịnh hành</h2>
                        </header>
                        <div className="row">
                            {
                                products && products.map(value => (
                                    ...
                                    <div className="d-inline-block">
                                        <div className="media align-items-end">
                                            ...
                                            <div className="media-body text-left ml-3">
                                                ...
                                                <p className="text-small mb-0 text-muted">Hỗ trợ 24/24</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4">
                                    <div className="d-inline-block">
                                        <div className="media align-items-end">
                                            ...
                                            <div className="media-body text-left ml-3">
                                                <h6 className="text-uppercase mb-1">Ngày hội ưu đãi</h6>
                                                <p className="text-small mb-0 text-muted">Từ ngày 06/04 đến 20/4/2023 </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="container p-0">
                            <div className="row">
                                <div className="col-lg-6 mb-3 mb-lg-0">
                                    <h5 className="text-uppercase">ĐĂNG KÝ NHẬN TIN KHUYẾN MÃI!</h5>
                                    <p className="text-small text-muted mb-0"></p>
                                </div>
                                <div className="col-lg-6">
                                    <form action="#">
                                        <div className="input-group flex-column flex-sm-row mb-3">
                                            <input className="form-control form-control-lg py-3" type="email" placeholder="Nhập vào email của bạn" aria-describedby="button-addon2" />
                                            <div className="input-group-append">
                                                <button className="btn btn-dark btn-block" id="button-addon2" type="submit">ĐĂNG KÝ</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
