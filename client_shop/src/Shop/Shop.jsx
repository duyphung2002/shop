...
function Shop(props) {
    ...
    const [pagination, setPagination] = useState({
        ...
        count: '9',
        // search: '',
        category: 'all, ao, quan, dongho, phukien'
    })
                                    ...
                                    <div className="row align-items-stretch">
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            <div className="p-5 my-md-4">
                                                ...
                                                <p className="text-small mb-4">Khách hàng là rất quan trọng, khách hàng sẽ được theo dõi bởi khách hàng. Để cơ thể chữa lành, nó cần có chế độ ăn uống lâm sàng. Cùng với những người bạn đồng hành của mình</p>
                                                <div className="row align-items-stretch mb-4">
                                                    <div className="col-sm-5 pl-sm-0 fix_addwish">
                                                        <a className="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0">
                                                            <i className="far fa-heart mr-2"></i>Thêm vào danh sách ưu thích</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="container p-0">
                    <div className="row">
                        <div className="col-lg-3 order-2 order-lg-1">
                            <h5 className="text-uppercase mb-4">Sản phẩm</h5>
                            <div className="py-2 px-4 bg-dark text-white mb-3"><strong className="small text-uppercase font-weight-bold">Thời trang</strong></div>
                            <ul className="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                                <li className="mb-2"><a className="reset-anchor" href="#" onClick={() => handlerCategory('all')}>TẤT CẢ</a></li>
                            </ul>
                            {/* <ul className="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                                <li className="mb-2"><a className="reset-anchor" href="#" onClick={() => handlerCategory('ao')}>Áo</a></li>
                            </ul> */}
